...
const input: RegistrationInput = { email: ' Cliente@Example.com ', password: 'UnaClaveLarga123!', repeatPassword: 'UnaClaveLarga123!', firstName: ' Ana ', lastName: ' Pérez ', phone: '+54 11 12345678', accepted: true, termsVersion: policy.termsVersion, privacyVersion: policy.privacyVersion }
