...
- El layout de cliente comprobará primero el rol de la sesión. Un usuario autenticado de otro rol recibirá 404 sin cerrar su sesión ni entrar en el flujo de completar perfil. Sólo un cliente válido pasará a la comprobación de perfil y dirección.
