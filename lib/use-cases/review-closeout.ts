import { assertCanReviewJob, createReviewCommand, type ReviewCommandInput } from '../reviews/review.ts'
import { recalculateProfessionalRating, shouldOpenQualityCase, type ReviewScore } from '../reviews/recalculate-rating.ts'
...
export function submitReviewCloseout(input: ReviewCloseoutInput) {
  ...
  return {
    ...
    nextActions: shouldOpenQualityCase(input.score) ? ['notify_admin_quality', 'freeze_auto_rating_boost'] : ['thank_customer', 'update_professional_score']
  }
}
