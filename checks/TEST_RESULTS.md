...
- Integración de migraciones T15–T31 y pgTAP: Docker Desktop falla al iniciar porque `dockerInference` es un reparse point inaccesible. Se reintentó sin borrar ni resetear datos y se conservó el bloqueo.
