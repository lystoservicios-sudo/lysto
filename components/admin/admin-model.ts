...
export const adminModules = [
  ...
  {
    group: 'Personas y equipos',
    items: [
      ['Profesionales', 'profesionales'],
      ['Invitaciones', 'profesionales/invitaciones'],
      ['Clientes', 'clientes'],
      ['Equipos', 'equipos']
    ]
  },
...
export type AdminPermission = 'owner' | 'operations' | 'finance' | 'quality'

const modulePermissions: Record<string, readonly AdminPermission[]> = {
  dashboard: ['operations'],
  solicitudes: ['operations'],
  trabajos: ['operations'],
  matching: ['operations'],
  zonas: ['operations'],
  profesionales: ['operations'],
  'profesionales/invitaciones': ['operations'],
  clientes: ['operations'],
  equipos: ['operations'],
  calidad: ['quality'],
  reclamos: ['quality'],
  ...
  auditoria: ['owner'],
  pagos: ['finance'],
  reportes: ['operations', 'finance'],
  precios: ['finance'],
  marketplace: ['finance'],
  servicios: ['operations'],
  diagnostico: ['operations'],
  notificaciones: ['operations'],
  configuracion: ['owner']
}

export function canAccessAdminModule(route: string, permissions: readonly string[]) {
  if (permissions.includes('owner')) return true
  return (modulePermissions[route] ?? []).some((permission) => permissions.includes(permission))
}
