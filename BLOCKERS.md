...
| `lysto-demo` comparte Supabase productivo y no es staging aislado | bloquea E2E remoto, carga, alertas, restore y smoke | separar backend, secretos y cuentas sintéticas; designar dueño y registrar `production:false` |
